...
class Db
{
    ...
    public static function queryNext($query, $params = array())
	{
		$result = self::$connection->prepare($query);
		$result->execute($params);

       
       $rowset1['Status'] = $result->fetch(PDO::FETCH_ASSOC);
       //$result->fetch(PDO::FETCH_ASSOC);  
       $result->nextRowset();  
       $rowset2['item_ronda'] = $result->fetchAll(PDO::FETCH_ASSOC);  
       
       
       $array= array_merge($rowset1,$rowset2);
